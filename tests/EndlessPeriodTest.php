...
use Spatie\Period\EndlessPeriod;
use Spatie\Period\Period;
use Spatie\Period\Precision;
use Spatie\Period\Boundaries;
use PHPUnit\Framework\TestCase;

class EndlessPeriodTest extends TestCase
{
    /** @test */
    public function it_can_determine_the_period_length()
    {
        $period = EndlessPeriod::make('2018-01-01');

        $this->assertEquals(null, $period->length());
    }
    ...
    public function it_can_determine_if_two_periods_touch_each_other()
    {
        ...
        $this->assertTrue(
            EndlessPeriod::make('2018-01-01')
                ->touchesWith(EndlessPeriod::make('2018-01-03'))
        );

        $this->assertTrue(
            EndlessPeriod::make('2018-01-03')
                ->touchesWith(EndlessPeriod::make('2018-01-01'))
        );
    }
